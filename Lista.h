...
public:
	...
	void ordenar(Nodo<Generico>* _inicio, function<bool(Nodo<Generico>*, Nodo<Generico>*)> condicion) {
	...
	void Encontrar_Usuariopos(int posicion, function<void(Generico)> imprime) {
	...
	Nodo<Generico>* Elim_UltimoUsuario(Nodo<Generico>* f, function<bool(Nodo<Generico>*)> condicion) {
		Nodo<Generico>* aux = fin;
		if (condicion(aux)) {
			fin = fin->getatras();
			delete aux;
